Python scripts used to run MARIO (devo version) during the prodcution of manuscript. Note the current version should not run this script as grammar etc has slightly changed. Deposited as record.
