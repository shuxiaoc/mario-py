#### Bokai Zhu
#### Script used to perform MARIO with the data presented in Figure 3
#### human whole blood sample challenged with H1N1
#### human and non-human primate whole blood sample challenged with Interferon gamma
...
###################### first match wcct human -> xspecies human interferon gamma

# read in data
df1_full = pd.read_csv("../data/Cytof-Xspecies-IFNG/wcct4d_term_srcluster120k.csv")
df2_full = pd.read_csv("../data/Cytof-Xspecies-IFNG/zac_ifgn_term_srcluster120k.csv")
...
for i in range(loop):
    ...
    path2="Zac_human_ifng_sr_matched"+str(idx)+".csv"
...
df2_full = pd.read_csv("../data/Cytof-Xspecies-IFNG/zac_Rheus_ifgn_term_srcluster120k.csv") # rhesus data
...
for i in range(loop):
    ...
    print("saving files")
    path1="wcct_sr_matched"+str(idx)+".csv"
    path2="Zac_rheus_ifng_sr_matched"+str(idx)+".csv"
    df1_m.to_csv(path_core+path1)
...
df1_full = pd.read_csv("../data/Cytof-Xspecies-IFNG/wcct4d_term_srcluster120k.csv") # the same wcct human 
df2_full = pd.read_csv("../data/Cytof-Xspecies-IFNG/zac_Cyno_ifgn_term_srcluster120k.csv") # cynomolgus data
...
for i in range(loop):
    ...
    print("saving files")
    path1="wcct_sr_matched"+str(idx)+".csv"
    path2="Zac_cyno_ifng_sr_matched"+str(idx)+".csv"
    df1_m.to_csv(path_core+path1)
    df2_m.to_csv(path_core+path2)
...
zh1 = pd.read_csv("../temp/location/Zac_human_sr_matched1.csv")
zh2 = pd.read_csv("../temp/location/Zac_human_sr_matched2.csv")
zh3 = pd.read_csv("../temp/location/Zac_human_sr_matched3.csv")
zh4 = pd.read_csv("../temp/location/Zac_human_sr_matched4.csv")
zhfull=zh1.copy()
...
# these files are then concatenated into the matched_files in the data folder