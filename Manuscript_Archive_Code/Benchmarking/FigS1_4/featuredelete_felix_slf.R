...
write.csv(container,"../Benchmarking/data/feature_deletion/felix/seurat/metrics.csv")
...
for (item in feature_2_delete){
  ...
  x_value=x
  y_value=y
  #dont scale for liger otherwise will be errorness result
  ...
  # some cell missing after reduction, possibily due to bad integration
...
write.csv(container,"../Benchmarking/data/feature_deletion/felix/liger/metrics.csv")
###### fstmnn
...
write.csv(container,"../Benchmarking/data/feature_deletion/felix/fstmnn/metrics.csv")
