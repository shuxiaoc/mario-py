...
import scanorama
# some parameters
path0 = "../Benchmarking/data/delete_cell_types/sxc_bm/" # read in same cells as tested in MARIO
path = "../Benchmarking/data/delete_cell_types/"
x = pd.read_csv(path0+"orig_x.csv")
y = pd.read_csv(path0+"orig_y.csv")
## some parameters
celltype_2_delete = ['pDCs','NK','B','CD8 T','CD4 T','monocyte']
#feature_2_delete = []
path_out = path + "scan_bm/"
