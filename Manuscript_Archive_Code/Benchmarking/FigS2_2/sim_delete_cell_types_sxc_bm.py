...
if __name__ == "__main__":
    ...
    path = 'data/delete_cell_types/sxc_bm'
    ...
    df2 = df2.iloc[np.random.choice(n2, 32000, replace=False), :] # 40k cells intotal
    ...
    cell_types_to_delete = [
        'pDCs','NK','B','CD8 T','CD4 T','monocyte'
    ]
    ...
    run_delete_cell_types(df1, df2, x_labels, y_labels, cell_types_to_delete,
                        ...
                        top_k=3, n_test=20, flip_prob=0.2, subsample_prop=1, subsample_rounds=1, n_wts=10,
