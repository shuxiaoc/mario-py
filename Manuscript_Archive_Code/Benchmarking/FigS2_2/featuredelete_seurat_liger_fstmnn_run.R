...
#### seurat
## read in 
path0 = "../Benchmarking/data/feature_deletion/bm_levine/sxc/" 
path = "../Benchmarking/data/feature_deletion/bm_levine/"
...
write.csv(container,"../Benchmarking/data/feature_deletion/bm_levine/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/feature_deletion/bm_levine/liger/metrics.csv")
...
write.csv(container,"../Benchmarking/data/feature_deletion/bm_levine/fstmnn/metrics.csv")
