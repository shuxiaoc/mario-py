## read in 
path0 = "../Benchmarking/data/delete_cell_types/human_crab_il4/sxc/"
path = "../Benchmarking/data/delete_cell_types/human_crab_il4/"
x = read.csv(paste0(path0,"orig_x.csv"))
y = read.csv(paste0(path0,"orig_y.csv"))
## some parameters
celltype_2_delete = c('B','NK','Neutrophil','CD8 T','CD4 T','cMC')
...
write.csv(container,"../Benchmarking/data/delete_cell_types/human_crab_il4/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/delete_cell_types/human_crab_il4/fstmnn/metrics.csv")
