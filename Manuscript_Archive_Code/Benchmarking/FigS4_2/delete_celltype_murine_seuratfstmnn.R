## read in 
path0 = "../Benchmarking/data/delete_cell_types/murine/sxc/"
path = "../Benchmarking/data/delete_cell_types/murine/"
x = read.csv(paste0(path0,"orig_x.csv"))
y = read.csv(paste0(path0,"orig_y.csv"))
## some parameters
celltype_2_delete = c('DC','NK','Mono','CD8 T','CD4 T','Mph')
...
write.csv(container,"../Benchmarking/data/delete_cell_types/murine/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/delete_cell_types/murine/fstmnn/metrics.csv")
