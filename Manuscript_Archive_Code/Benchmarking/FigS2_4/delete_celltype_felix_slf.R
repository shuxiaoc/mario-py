## read in 
path0 = "../Benchmarking/data/delete_cell_types/felix/sxc/"
path = "../Benchmarking/data/delete_cell_types/felix/"
x = read.csv(paste0(path0,"orig_x.csv"))
y = read.csv(paste0(path0,"orig_y.csv"))
## some parameters
celltype_2_delete = c('CD14 Mono','B','DC','NK','CD8 T','mem CD4 T')
...
write.csv(container,"../Benchmarking/data/delete_cell_types/felix/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/delete_cell_types/felix/fstmnn/metrics.csv")
