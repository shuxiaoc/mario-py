...
########### seurat start
## read in 
path0 = "../Benchmarking/data/noise_addition/sxc_bm/"
path = "../Benchmarking/data/noise_addition/"
...
for (item in noise_level){
  ...
  pre.anchors <- FindTransferAnchors(reference = y_obj, query = x_obj, 
                                     dims = 1:(length(features)-1), features = features)
...
write.csv(container,"../Benchmarking/data/noise_addition/seurat_bm/metrics.csv")
...
write.csv(container,"../Benchmarking/data/noise_addition/fstmnn_bm/metrics.csv")
...
write.csv(container,"../Benchmarking/data/noise_addition/liger_bm/metrics.csv")
