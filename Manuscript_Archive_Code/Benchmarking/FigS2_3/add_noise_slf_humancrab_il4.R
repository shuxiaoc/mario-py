...
########### seurat start
## read in 
path0 = "../Benchmarking/data/noise_addition/humancrab_il4/sxc/"
path = "../Benchmarking/data/noise_addition/humancrab_il4/"
...
write.csv(container,"../Benchmarking/data/noise_addition/humancrab_il4/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/noise_addition/humancrab_il4/fstmnn/metrics.csv")
...
write.csv(container,"../Benchmarking/data/noise_addition/humancrab_il4/liger/metrics.csv")
