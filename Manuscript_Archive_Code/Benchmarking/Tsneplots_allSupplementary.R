...
scan_x = read.csv("/home/bkzhu/SNE-multi/figure_rcode/mouse_cite/sup_related/scanorama_embedding_x0.csv")
scan_y = read.csv("/home/bkzhu/SNE-multi/figure_rcode/mouse_cite/sup_related/scanorama_embedding_y0.csv")
