...
wait
/usr/bin/Rscript calculate_metricsVer2.R 'data/feature_deletion/felix/liger/metrics.csv' 'data/feature_deletion/felix/liger/orig' 'data/feature_deletion/felix/liger/embedding' 9 &
wait
