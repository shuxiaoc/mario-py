...
write.csv(container,"../Benchmarking/data/noise_addition/felix/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/noise_addition/felix/fstmnn/metrics.csv")
...
write.csv(container,"../Benchmarking/data/noise_addition/felix/liger/metrics.csv")
