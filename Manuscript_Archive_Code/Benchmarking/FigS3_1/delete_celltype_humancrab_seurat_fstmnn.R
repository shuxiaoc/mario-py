...
write.csv(container,"../Benchmarking/data/delete_cell_types/human_crab/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/delete_cell_types/human_crab/fstmnn/metrics.csv")
