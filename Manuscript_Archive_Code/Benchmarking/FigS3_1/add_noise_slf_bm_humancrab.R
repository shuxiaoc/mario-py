...
########### seurat start
## read in 
path0 = "../Benchmarking/data/noise_addition/humancrab/sxc/"
path = "../Benchmarking/data/noise_addition/humancrab/"
...
write.csv(container,"../Benchmarking/data/noise_addition/humancrab/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/noise_addition/humancrab/fstmnn/metrics.csv")
...
write.csv(container,"../Benchmarking/data/noise_addition/humancrab/liger/metrics.csv")
