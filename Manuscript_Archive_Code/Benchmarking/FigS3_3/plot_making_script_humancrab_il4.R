...
sxc_path = "../Benchmarking/data/feature_deletion/human_crab_il4/sxc/metrics.csv"
seurat_path = "../Benchmarking/data/feature_deletion/human_crab_il4/seurat/metrics.csv"
liger_path = "../Benchmarking/data/feature_deletion/human_crab_il4/liger/metrics.csv"
fstmnn_path = "../Benchmarking/data/feature_deletion/human_crab_il4/fstmnn/metrics.csv"
scan_path = "../Benchmarking/data/feature_deletion/human_crab_il4/scan/metrics.csv"
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/1.svg", plot=p, width=6, height=3)
#ggsave()
# prop remain
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/2.svg", plot=p, width=6, height=3)
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/3.svg", plot=p, width=6, height=3)
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/4.svg", plot=p, width=6, height=3)
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/5.svg", plot=p, width=6, height=3)
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/6.svg", plot=p, width=6, height=3)
## ari_mix
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/7.svg", plot=p, width=6, height=3)
## ari_mix
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/8.svg", plot=p, width=6, height=3)
## ari_f1
####
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/9.svg", plot=p, width=6, height=3)
## lisi_mix
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/10.svg", plot=p, width=6, height=3)
## lisi_clust
...
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/11.svg", plot=p, width=6, height=3)
## avg_mix
#####
p = ggplot(data=match, aes(x=n_deleted, y=avg_mix, group=method)) +
  geom_line(aes(color=method))+
  geom_point(aes(color=method)) + theme_classic() + ggtitle("avg_mix") + theme(text = element_text(size=20)) + ylim(c(0.13,0.16))
ggsave(file="../Benchmarking/data/feature_deletion/human_crab_il4/figures/12.svg", plot=p, width=6, height=3)

#################################
# now start the add noise 
#################################

sxc_path = "../Benchmarking/data/noise_addition/humancrab_il4/sxc/metrics.csv"
seurat_path = "../Benchmarking/data/noise_addition/humancrab_il4/seurat/metrics.csv"
liger_path = "../Benchmarking/data/noise_addition/humancrab_il4/liger/metrics.csv"
fstmnn_path = "../Benchmarking/data/noise_addition/humancrab_il4/fstmnn/metrics.csv"
scan_path = "../Benchmarking/data/noise_addition/humancrab_il4/scan/metrics.csv"
# read metrics
a = read.csv(sxc_path)
colnames(a)[1] = "n_deleted"
colnames(a)[7] = "X1v1_acc"
## if avg_pval <0.05 with MARIO matchability test, stop match
a$X1v1_acc[c(6:9)] = NA
...
p = ggplot(data=match, aes(x=noise, y=X1v1_acc, group=method)) +
  geom_line(aes(color=method))+
  geom_point(aes(color=method)) + theme_classic() + ggtitle("accu") + theme(text = element_text(size=20)) +ylim(c(0.4,1))
ggsave(file="../Benchmarking/data/noise_addition/humancrab_il4/figures/15.svg", plot=p, width=6, height=3)
# prop remain
...
ggsave(file="../Benchmarking/data/noise_addition/humancrab_il4/figures/16.svg", plot=p, width=6, height=3)
...
sxc_path0.2 = "../Benchmarking/data/delete_cell_types/human_crab_il4/sxc/metrics.csv"
seurat_path = "../Benchmarking/data/delete_cell_types/human_crab_il4/seurat/metrics.csv"
fstmnn_path = "../Benchmarking/data/delete_cell_types/human_crab_il4/fstmnn/metrics.csv"
scan_path = "../Benchmarking/data/delete_cell_types/human_crab_il4/scan/metrics.csv"
# read metrics
...
ggsave(file="../Benchmarking/data/delete_cell_types/humancrab_il4/figures/17.svg", plot=p, width=6, height=3)
