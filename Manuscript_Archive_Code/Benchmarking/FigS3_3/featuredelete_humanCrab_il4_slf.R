...
#### seurat
## read in 
path0 = "../Benchmarking/data/feature_deletion/human_crab_il4/sxc/"
path = "../Benchmarking/data/feature_deletion/human_crab_il4/"
...
write.csv(container,"../Benchmarking/data/feature_deletion/human_crab_il4/seurat/metrics.csv")
...
write.csv(container,"../Benchmarking/data/feature_deletion/human_crab_il4/liger/metrics.csv")
###### fstmnn
...
write.csv(container,"../Benchmarking/data/feature_deletion/human_crab_il4/fstmnn/metrics.csv")
